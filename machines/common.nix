...

{
  ...
  environment.systemPackages = with pkgs; [
    wget nano firefox tree ag lsof lxqt.pavucontrol-qt git idea.idea-community maven jdk11 gnumake tig gparted acpi htop freecad hibernate arduino php74Packages.composer redis pstree lm_sensors cpufrequtils font-awesome waybar pavucontrol wirelesstools iw networkmanager neofetch fzf
